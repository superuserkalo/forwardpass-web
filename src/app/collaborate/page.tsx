...
export default function Collaborate() {
  return (
    <main className="relative min-h-screen bg-background">
      <div className="mx-auto flex min-h-screen max-w-3xl items-center px-5 py-20 md:px-10">
        <CollaboratePanel>
          <p className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Advertising &amp; sponsorship</p>
          <h1 className="font-display mt-5 max-w-xl text-4xl font-medium leading-tight tracking-[-0.02em] sm:text-5xl">
